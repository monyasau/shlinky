...
<div className="max-w-screen-xl mx-auto  flex items-center justify-between h-screen">
...
<div className="flex rounded-lg  px-4 border justify-between items-center">
