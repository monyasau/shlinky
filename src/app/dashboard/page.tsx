              ...
              <div className="flex justify-center">
                ...
                {userLinks.map((link) => (
                  <div key={link.id} className="bg-[#fafafa] rounded-xl p-5">
                    <div className="flex mb-4 justify-between"><div className="flex text-[#737373] gap-2 items-center text-base font-bold"><svg width="12" height="6" viewBox="0 0 12 6" fill="none" xmlns="http://www.w3.org/2000/svg">
<rect width="12" height="1" fill="#737373"/>
<rect y="5" width="12" height="1" fill="#737373"/>
</svg> Link # {userLinks.indexOf(link)+1}
</div>
<button className="text-[#737373] " onClick={() => removeLink(link.id)}>Remove</button>
</div>
<label htmlFor="email">
                <p className="text-sm text-[#333333] mb-1">Platform</p>
                <div
                  className="flex customShadow bg-white rounded-lg  px-4 border justify-between items-center"
                ><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#737373" class="size-6">
